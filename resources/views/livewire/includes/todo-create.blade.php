<div class=" bg-white p-8 mt-5 rounded-sm border-t-green-600 border-t-4 shadow-md w-4/5 md:w-3/6 lg:w-2/6 ">
    ...
    <div class="w-full pt-4 pb-2">
        ...
        <div class="relative mt-2 rounded-md shadow-sm">
            <input wire:model="name" type="text" name="price" id="price"
    ...
    <div class="flex items-center">
        <button wire:click="createNewTodo" class=" bg-blue-600 rounded-md flex items-center mt-5 px-3 py-2 text-white cursor-pointer">
        ...
        <!-- <div> -->
        @if (session('status'))
            <span class="text-green-600 mt-5 pl-4">
                {{ session('status') }}
            </span>
        @endif
        <!-- </div> -->
